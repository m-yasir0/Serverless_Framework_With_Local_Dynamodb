...
// src/functions/deleteUser/handler.ts
__export(exports, {
  main: () => main
});

// src/libs/apiGateway.ts
var _200_formatJSONResponse = (response) => {
  return {
    statusCode: 200,
    body: JSON.stringify(response)
  };
};
var _400_formatJSONResponse = (response) => {
  return {
    statusCode: 400,
    body: JSON.stringify(response)
  };
...
// src/functions/deleteUser/handler.ts
var deleteRecordById = async (event) => {
  var _a;
  try {
    let record = await new DynameDb(process.env.IS_OFFLINE, "Users").deleteRecordById((_a = event.pathParameters) == null ? void 0 : _a.id);
...
var main = middyfy(deleteRecordById);
